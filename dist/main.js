...
$templateCache.put("views/reset-password.directive.html","<div ng-show=\"!vm.success\"><h1>reset password</h1><p class=\"secondary\">Please enter your new password.</p><p ng-show=\"vm.error\" class=\"error\">{{ vm.error }}</p><form ng-submit=\"vm.submit()\"><input type=\"password\" ng-model=\"vm.password\" required=\"required\" placeholder=\"New Password\" autofocus=\"autofocus\" class=\"widest\"/><button type=\"submit\" class=\"action\">reset password</button></form></div><p ng-show=\"vm.success\" class=\"success\">Your password has been updated.</p>");
